      ...
      <nav className="absolute w-full px-3 mt-2 z-1" id='Navbar'>
        ...
        <div className={`${isOpen ? 'block' : 'hidden'} md:hidden bg-gray-100 rounded-2xl`} id="mobile-menu">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <HashLink to="/" className="block text-gray-800 hover:bg-gray-500 hover:text-black transition-all duration-300 ease-in-out px-3 py-2 rounded-md font-medium">Home</HashLink>
            <HashLink to="/#skills" className="block text-gray-800 hover:bg-gray-500 hover:text-black transition-all duration-300 ease-in-out px-3 py-2 rounded-md font-medium">Skills</HashLink>
            <HashLink to="/#Projects" className="block text-gray-800 hover:bg-gray-500 hover:text-black transition-all duration-300 ease-in-out px-3 py-2 rounded-md font-medium">Projects</HashLink>
            <HashLink to="/#Experience" className="block text-gray-800 hover:bg-gray-500 hover:text-black transition-all duration-300 ease-in-out px-3 py-2 rounded-md font-medium">Experience</HashLink>
