      ...
      <div className="bg-black py-5 my-[1vh]" id='Projects'>
        ...
        <div className="flex flex-wrap justify-around px-5">
          ...
          <div className={`w-full mx-auto flex justify-center items-center my-10 text-white ${isVisible ? "hidden" : ""}`} onClick={handleClick}>
            <Link to="/projects">
            <div className="group flex space-x-3 py-3 px-5 border-2 transition-all duration-750  border-white hover:border-gray-50 rounded-2xl cursor-pointer text-white hover:text-black hover:bg-white bg-[#131313]">
              <span className='font-bold'>See More Projects</span>
